...
| `AI_API_KEY` | NVIDIA NIM (integrate.api.nvidia.com) — modèle DeepSeek V4 Flash | Non | Non | Remplacer la clé (lue à chaque appel). Clé API NVIDIA : `https://build.nvidia.com/` → AI Foundation Models → Get API Key |
